    ...
    private void seedPrograms() {
        ...
        String[][] programs = {
            {"After-School Program", "after-school-program",
             "Supporting refugee, immigrant, and K-12 students academically while addressing the practical needs of families through tutoring, mentorship, and a safe learning environment.",
             "Education", "K-12 students", "Mon–Fri, 3:00–6:00 PM", "Main Community Center",
             "fas fa-graduation-cap", "1"},
            {"Early Childhood Education", "early-childhood-education",
             "Helping children ages 3 to 5 build the skills they need before entering kindergarten, with a focus on early learning, communication, social, and emotional development.",
             "Education", "Children ages 3–5", "Mon–Fri, 8:00 AM–4:00 PM", "Main Community Center",
             "fas fa-child", "2"},
            {"Economic Upskilling", "economic-upskilling",
             "Supporting individuals and families who come to the U.S. with valuable skills but face workforce barriers — building confidence, job readiness, and connections to financial stability.",
             "Workforce", "Adults 18+", "Tuesdays & Thursdays, 6:00–8:00 PM", "Career Lab",
             "fas fa-briefcase", "3"},
            {"Community Meetings", "community-meetings",
             "Bringing families, leaders, volunteers, partners, and supporters together to discuss community needs and create practical, collaborative solutions.",
             "Community", "All community members", "1st Saturday monthly, 10:00 AM", "Community Hall",
             "fas fa-users", "4"},
            {"Driving Practice Program", "driving-practice-program",
             "Helping refugees, immigrants, and community members gain hands-on driving experience to build confidence, improve road safety skills, and prepare for the Iowa DOT driving test.",
             "Transportation", "Adults 16+", "Saturdays, 9:00 AM–1:00 PM", "Parking Facility",
             "fas fa-car", "5"},
            {"Summer Enrichment Program", "summer-enrichment-program",
             "Giving English learners in grades 1–12 continued learning opportunities during summer, strengthening academic language and skills in reading, math, science, and more.",
             "Youth", "English learners grades 1–12", "June–August, Mon–Fri", "Various Locations",
             "fas fa-sun", "6"}
        };
